...
ec2.meta.client.associate_address(InstanceId=instance.id, PublicIp='13.235.234.251')

print("New Ubuntu Backend instance is created and associated with Elastic IP (13.235.234.251).")